              ...
              <Card.Meta
                ...
                title={
                  <h4 className="mt-0 mb-0 fs-11">
                    <CalendarOutlined className="mr-1" style={{ fontSize: 18, marginTop: 4 }} />
                    {dayjs(entretien.date).format("DD MMM YYYY")}
                    <span className="ml-1 legende">{dayjs(entretien.date).fromNow()}</span>
                  </h4>
                }
                description={
                  <Space size={4} orientation="vertical" className="text-text w-100">
                    ...
                    {entretien.fichier && <Fichier fichierId={entretien.fichier} hideDownload />}
