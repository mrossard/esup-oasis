...
import { IPeriode, IServicesFaits, IServicesFaitsLigne } from "@api";
...
export function ServicesFaits(): ReactElement {
  ...
  const [defaultTab] = useState(searchParams.get("historique") === "1" ? "historique" : "en-cours");
                  ...
                  <Alert
                    ...
                    description={
                      <>
                        ...
                        . Les heures de cette période sont payées à la fin du mois prochain à
                        condition que le contrat soit signé lors de la déclaration des heures en fin
                        de période.
                        <br />
                        Si vous constatez une erreur et que vous souhaitez apporter une
                        modification, merci de prendre contact avec la personne qui vous a recruté•e
                        pour cet évènement.
                      </>
                    }
                  />
                  ...
                  <Alert
                    ...
                    description={
                      <>
                        ...
                        <br />
                        <b>Important :</b> les montants indiqués sont des montants bruts. Ils sont
                        donnés à titre indicatif et ne tiennent pas compte des éventuels ajustements
                        qui pourraient être apportés par le service RH.
                        <br />
                        Si le contrat n'est pas signé au moment de la déclaration de ces heures aux
                        RH, le paiement est décalé au mois suivant jusqu'à signature.
                      </>
                    }
                  />
